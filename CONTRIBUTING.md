...
- **Node 8 LTS:** `generator-generator-ts` has a minimum Node version
...
``` bash
git clone https://github.com/EndemolShineGroup/generator-generator-ts.git
cd generator-generator-ts
yarn
yarn test
```
...
We want to ensure that `generator-generator-ts` is secure for everyone. If
